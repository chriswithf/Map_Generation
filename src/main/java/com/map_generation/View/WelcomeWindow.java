...
public class WelcomeWindow extends VBox {
    ...
    public WelcomeWindow() {
        ...
        title.setStyle("-fx-font-size: 24pt; " + "-fx-font-family: 'Arial Black'; " + "-fx-text-fill: white; " + "-fx-background-color: #333333; " + "-fx-padding: 10px;");
        title.setMaxWidth(Double.MAX_VALUE);

        // create the label for the text fields
        Label sizeLabel = new Label("Enter screen-size: ");
        sizeLabel.setStyle("-fx-font-size: 10pt; " + "-fx-font-weight: bold; " + "-fx-text-fill: #333333; " + "-fx-padding: 10px;");
        ...
        widthTextField.setStyle("-fx-font-size: 10pt; " + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10px;");

        TextField heightTextField = new TextField();
        heightTextField.setPromptText("height");
        heightTextField.setTooltip(new Tooltip("Must be between " + MIN + " and " + MAX_HEIGHT));
        heightTextField.setStyle("-fx-font-size: 10pt; " + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10px;");

        // create the text fields for octaves
        Label octaveLabel = new Label("Enter Octaves: ");
        octaveLabel.setStyle("-fx-font-size: 10pt; " + "-fx-font-weight: bold; " + "-fx-text-fill: #333333; " + "-fx-padding: 10px;");
        ...
        octaveTextField.setStyle("-fx-font-size: 10pt; " + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10px;");
        ...
        persistanceLabel.setStyle("-fx-font-size: 10pt; " + "-fx-font-weight: bold; " + "-fx-text-fill: #333333; " + "-fx-padding: 10px;");
        ...
        persistanceTextField.setStyle("-fx-font-size: 10pt; " + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10px;");
        ...
        start.setStyle("-fx-font-size: 13pt; " + "-fx-background-color: #333333; " + "-fx-text-fill: white; " + "-fx-padding: 10px;");
        ...
        TextFormatter<Integer> widthFormatter = new TextFormatter<>(new IntegerStringConverter(), // Use IntegerStringConverter to convert to/from Integer
                null, // Set initial value to null
                filter // Use the unary operator filter to accept only integer values
        );
        TextFormatter<Integer> heightFormatter = new TextFormatter<>(new IntegerStringConverter(), null, filter);
    ...
    private void showHelpDialog() {
        ...
        VBox vbox = new VBox(introLabel, inputHeaderLabel, windowSizeLabel, numOctavesLabel, persistenceLabel, inputDescriptionLabel, terraformHeaderLabel, terraformDescriptionLabel, modifyHeaderLabel, modificationDescriptionLabel);
        vbox.setSpacing(5);
